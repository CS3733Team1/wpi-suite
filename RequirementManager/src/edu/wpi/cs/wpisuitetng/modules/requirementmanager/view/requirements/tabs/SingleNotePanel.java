...
public class SingleNotePanel extends JPanel {
	...
	public SingleNotePanel(Note note) {
		this.setBorder(BorderFactory.createLineBorder(Color.black)); // Set note
																		// border
		...
		noteConstraints.fill = GridBagConstraints.HORIZONTAL; // Fill elements
																// horizontally
		...
		noteConstraints.anchor = GridBagConstraints.SOUTHEAST; // Display info
																// in btm-right
	 ...
	 * 
	 * @param list
	 *            List of note used to create panel
	 * 
	...
	public static JPanel createList(NoteList list) {
		...
		GridBagConstraints c = new GridBagConstraints(); // Create layout for
															// adding notes
		c.gridy = GridBagConstraints.RELATIVE; // Make a new row and add it to
												// it
