...
public class RequirementModel extends AbstractListModel<Object> {
	 ...
	 * 
	 * 
	 * @return the requirement associated with the provided index * @see
	 ...
	 *            the iteration to get requirements for
	 * 
