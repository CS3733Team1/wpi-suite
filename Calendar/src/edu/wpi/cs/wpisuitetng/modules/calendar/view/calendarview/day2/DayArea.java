			...
			for(ISchedulable test:map.get(i)){
				...
				for(ISchedulable test2:overlapEvents){
					...
					if(eventDivs>divisions){
						divisions=eventDivs;
//						System.out.print("event causing change in divs ");
//						System.out.print(test2.getName());
//						System.out.print(" event changed: ");
//						System.out.print(test.getName());
//						System.out.println(" #divs: ");
//						System.out.println(eventDivs);
					}
				}
				...
				//debugging tooltip info
				infobuilder.append("<br><b>Divisions: </b>");
				infobuilder.append(new Integer(divisions).toString());
				infobuilder.append("<br><b>Overlaps:</b>");
				for(int k=0;k<overlapEvents.size();k++){
					infobuilder.append("<br>");
					infobuilder.append(overlapEvents.get(k).getName());
				}
