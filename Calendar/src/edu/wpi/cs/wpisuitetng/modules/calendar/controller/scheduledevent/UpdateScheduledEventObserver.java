...
public class UpdateScheduledEventObserver implements RequestObserver {
	private final UpdateScheduledEventController controller;

	/**
	 * Constructs the observer given an UpdateCommitmentController
	 * @param controller The controller used to update commitments
	 */
	public UpdateScheduledEventObserver(UpdateScheduledEventController controller) {
	...
	public void responseSuccess(IRequest iReq) {
		...
		controller.updateScheduledEventInModel(scheduledEvent);
	}
