...
public class EventListComponent extends RenderableComponent<Event> {
	...
	@Override
	public JComponent create(ListItem<Event> listItem) {
		Event event = listItem.getListObject();
	...
	@Override
	public void update(ListItem<Event> listItem) {
		p.setBackground(listItem.isSelected() ? CalendarUtils.selectionColor : Color.WHITE);
