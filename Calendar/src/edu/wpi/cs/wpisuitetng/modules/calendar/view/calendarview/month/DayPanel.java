...
public class DayPanel extends JPanel {
	...
	public void addEvent(Event event) {		
		...
		JLabel eventTimeLabel = new JLabel(DateUtilities.timeToString(event.getStartDate()));
	...
	public void addCommitment(Commitment commitment) {
		...
		JLabel commitmentTimeLabel = new JLabel(DateUtilities.timeToString(commitment.getDueDate()));
