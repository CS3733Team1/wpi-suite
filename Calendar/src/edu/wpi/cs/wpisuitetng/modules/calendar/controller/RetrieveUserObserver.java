...
public class RetrieveUserObserver implements RequestObserver{
	private RetrieveUserController controller;
	
	public RetrieveUserObserver(RetrieveUserController controller) {
	...
	public void responseSuccess(IRequest iReq) {
		System.out.println("	The request to retrieve a user was successful.");
		final User user = User.fromJSON(iReq.getResponse().getBody());
		controller.receivedMessages(user);
	}
	...
	public void responseError(IRequest iReq) {
		...
		System.err.println("	Failed to retrieve a user from the server.");
	}
