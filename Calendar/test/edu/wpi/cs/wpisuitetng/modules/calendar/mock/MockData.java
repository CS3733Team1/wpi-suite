...
public class MockData implements Data {
	 ...
	 * 
	 * 
	 * @return T * @see edu.wpi.cs.wpisuitetng.database.Data#delete(T) * @see
	 ...
	 * 
	 * 
	 * @return boolean * @see edu.wpi.cs.wpisuitetng.database.Data#save(T) * @see
	 ...
	 *            Object
	 * 
	 * @see edu.wpi.cs.wpisuitetng.database.Data#update(Class, String, Object,
	 *      String, Object)
	 */
	@Override
	 ...
	 * 
	 * 
	 * @return List<Model> * @throws WPISuiteException * @throws
	 *         IllegalArgumentException * @throws IllegalAccessException * @throws
	 *         InvocationTargetException * @see
	 *         edu.wpi.cs.wpisuitetng.database.Data#andRetrieve(Class, String[],
	 *         List<Object>) * @throws WPISuiteException
	 ...
	 *         edu.wpi.cs.wpisuitetng.database.Data#orRetrieve(Class, String[],
	 *         List<Object>) * @throws WPISuiteException
	 * @throws IllegalAccessException
	 * @throws InvocationTargetException
	 ...
	 * 
	 * 
	 * @return List<Model> * @throws WPISuiteException * @see
	 *         edu.wpi.cs.wpisuitetng.database.Data#retrieve(Class, String,
	 ...
	 *         Project) * @see edu.wpi.cs.wpisuitetng.database.Data#save(T,
	 *         Project)
	 */
	@Override
