...
public class FilterBackendTest {

	static MockData db;
	static User USER;
	static Session SESSION;
	static String SSID;
	static FilterEntityManager manager;
	...
	public void setUp() throws Exception {
		...
		db.save(USER);
		manager = FilterEntityManager.getFilterEntityManager(db);
	}
	...
	public void testMakeEntity() throws WPISuiteException {
		Filter com1 = manager.makeEntity(SESSION, new Filter().toJSON());
	...
	{
		testMakeEntity();
		Filter [] coms = manager.getAll(SESSION);
	...
	public void testGetSpecific() throws WPISuiteException
	{
		...
		Filter com2 = manager.getEntity(SESSION,String.format("%d", com1.getUniqueID()))[0];
