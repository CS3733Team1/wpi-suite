...
/**
 * The Data Model representation of a Project. Offers serialization and database
 * interaction.
 * 
...
public class Project extends AbstractModel {
	 ...
	 *            - the project name
	 * @param idNum
	 *            - the project ID number as a string
	 * @param owner
	 *            - The User who owns this project
	 * @param team
	 *            - The User[] who are associated with the project
	 * @param supportedModules
	 *            - the modules supported by this project
	 */
	public Project(String name, String idNum, User owner, User[] team,
	 ...
	 *            the project name
	 * @param idNum
	 *            the ID number to associate with this Project.
	 */
	...
	/*
	 * private void setIdNum(String newId) { this.idNum = newId; }
	 */
	...
	/**
	 * Static Project method that serializes a list of Projects into JSON
	 * strings.
	 * 
	 * @param u
	 *            The list of Projects to serialize
	...
	/**
	 * Returns the JSON representation of this object as the toString.
	 * 
	...
	public boolean equals(Object anotherProject) {
		if (anotherProject instanceof Project) {
			if (((Project) anotherProject).idNum.equals(this.idNum)) {
				...
				if (this.name != null
						&& !this.name.equals(((Project) anotherProject).name)) {
					return false;
				}

				if (this.idNum != null
						&& !this.idNum.equals(((Project) anotherProject).idNum)) {
					return false;
				}
	 ...
	 * @return true if the user was added, false if the user was already in the
	 *         team
	 */
	 ...
	 * 
	 * @param u
	 *            - the team member to remove from the team
	 * @return - true if the member was removed, false if they were not in the
	 *         team
	 */
