 ...
 */
public class DefectEventListCellRenderer implements ListCellRenderer<Object> {
	...
	public Component getListCellRendererComponent(JList<?> list, Object value,
		...
		if (value instanceof Comment) { // if the cell contains a comment,
										// construct a ViewCommentPanel
			panel = new CommentPanel((Comment) value);
		} else if (value instanceof DefectChangeset) { // if the cell contains a
														// DefectChangeset, then
														// construct a
														// DefectChangesetPanel
			panel = new DefectChangesetPanel((DefectChangeset) value);
		} else if (value instanceof JPanel) { // if the cell contains a JPanel,
												// just display it
			panel = (JPanel) value;
		} else { // Otherwise just make an empty JPanel, and add a label with
